...
public class SmoothStreamingManifestParser implements Parser<SmoothStreamingManifest> {
    ...
    private static class TrackElementParser extends ElementParser {
        ...
        public Object build() {
            ...
            return new TrackElement(this.index, this.bitrate, this.mimeType, csdArray, this.maxWidth, this.maxHeight, this.samplingRate, this.channels);
        }
        ...
        private static String fourCCToMimeType(String fourCC) {
            ...
            if (fourCC.equalsIgnoreCase("dtsc") || fourCC.equalsIgnoreCase("dtse")) {
