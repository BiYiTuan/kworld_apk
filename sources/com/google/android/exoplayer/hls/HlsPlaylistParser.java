        ...
        while (iterator.hasNext()) {
            ...
            if (line.startsWith(MEDIA_TAG)) {
                if (SUBTITLES_TYPE.equals(HlsParserUtil.parseStringAttr(line, TYPE_ATTR_REGEX, TYPE_ATTR))) {
                    ...
                    subtitles.add(new Variant(uri, new Format(subtitleName, MimeTypes.TEXT_VTT, -1, -1, -1.0f, -1, -1, -1, language, codecs)));
                }
            } else {
                if (line.startsWith(STREAM_INF_TAG)) {
                    ...
                    if (!line.startsWith("#") && expectingStreamInfUrl) {
                        ...
                        variants.add(new Variant(line, new Format(name, MimeTypes.APPLICATION_M3U8, width, height, -1.0f, -1, -1, bitrate, null, codecs)));
                        bitrate = 0;
                        codecs = null;
                        name = null;
                        width = -1;
