...
import org.videolan.libvlc.MediaDiscoverer.Event;
            ...
            if (isHigher) {
                if (bufferedDurationUs < this.minDurationForQualityIncreaseUs) {
                    ...
                    for (int i = 1; i < queue.size(); i++) {
                        ...
                        if (thisChunk.startTimeUs - playbackPositionUs >= this.minDurationToRetainAfterDiscardUs && thisChunk.format.bitrate < ideal.bitrate && thisChunk.format.height < ideal.height && thisChunk.format.height < 720 && thisChunk.format.width < Event.Started) {
