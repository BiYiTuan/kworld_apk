...
public final class VideoFormatSelectorUtil {
    ...
    private static boolean isFormatPlayable(Format format, String[] allowedContainerMimeTypes, boolean filterHdFormats, int maxDecodableFrameSize) throws DecoderQueryException {
        ...
        if (filterHdFormats && (format.width >= Event.Started || format.height >= 720)) {
            return false;
        }
        if (format.width > 0 && format.height > 0) {
            ...
            if (Util.SDK_INT >= 21 && !MimeTypes.VIDEO_UNKNOWN.equals(videoMediaMimeType)) {
                return MediaCodecUtil.isSizeAndRateSupportedV21(videoMediaMimeType, false, format.width, format.height, (double) (format.frameRate > 0.0f ? format.frameRate : 30.0f));
