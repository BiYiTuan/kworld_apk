...
public final class MpegAudioHeader {
    private static final int[] BITRATE_V1_L1 = new int[]{32, 64, 96, 128, ThumbnailUtils.TARGET_SIZE_MICRO_THUMBNAIL_HEIGHT, 192, 224, 256, 288, ThumbnailUtils.TARGET_SIZE_MINI_THUMBNAIL_HEIGHT, 352, 384, HttpStatus.SC_REQUESTED_RANGE_NOT_SATISFIABLE, 448};
    private static final int[] BITRATE_V1_L2 = new int[]{32, 48, 56, 64, 80, 96, 112, 128, ThumbnailUtils.TARGET_SIZE_MICRO_THUMBNAIL_HEIGHT, 192, 224, 256, ThumbnailUtils.TARGET_SIZE_MINI_THUMBNAIL_HEIGHT, 384};
    private static final int[] BITRATE_V1_L3 = new int[]{32, 40, 48, 56, 64, 80, 96, 112, 128, ThumbnailUtils.TARGET_SIZE_MICRO_THUMBNAIL_HEIGHT, 192, 224, 256, ThumbnailUtils.TARGET_SIZE_MINI_THUMBNAIL_HEIGHT};
    private static final int[] BITRATE_V2 = new int[]{8, 16, 24, 32, 40, 48, 56, 64, 80, 96, 112, 128, 144, ThumbnailUtils.TARGET_SIZE_MICRO_THUMBNAIL_HEIGHT};
    private static final int[] BITRATE_V2_L1 = new int[]{32, 48, 56, 64, 80, 96, 112, 128, 144, ThumbnailUtils.TARGET_SIZE_MICRO_THUMBNAIL_HEIGHT, 176, 192, 224, 256};
    ...
    public static boolean populateHeader(int headerData, MpegAudioHeader header) {
        ...
        header.setValues(version, MIME_TYPE_BY_LAYER[3 - layer], frameSize, sampleRate, ((headerData >> 6) & 3) == 3 ? 1 : 2, bitrate, samplesPerFrame);
        return true;
    }
