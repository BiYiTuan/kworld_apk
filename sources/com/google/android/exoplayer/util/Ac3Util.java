...
public final class Ac3Util {
    ...
    private static final int[] BITRATE_BY_HALF_FRMSIZECOD = new int[]{32, 40, 48, 56, 64, 80, 96, 112, 128, ThumbnailUtils.TARGET_SIZE_MICRO_THUMBNAIL_HEIGHT, 192, 224, 256, ThumbnailUtils.TARGET_SIZE_MINI_THUMBNAIL_HEIGHT, 384, 448, 512, 576, 640};
    ...
    public static int parseEAc3SyncframeAudioSampleCount(ByteBuffer buffer) {
        return (((buffer.get(buffer.position() + 4) & 192) >> 6) == 3 ? 6 : BLOCKS_PER_SYNCFRAME_BY_NUMBLKSCOD[(buffer.get(buffer.position() + 4) & 48) >> 4]) * 256;
    }
