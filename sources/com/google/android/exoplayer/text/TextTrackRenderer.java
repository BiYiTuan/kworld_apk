...
public final class TextTrackRenderer extends SampleSourceTrackRenderer implements Callback {
    ...
    protected void doSomeWork(long positionUs, long elapsedRealtimeUs) throws ExoPlaybackException {
        ...
        if (getState() == 3) {
            ...
            if (!this.inputStreamEnded && this.nextSubtitle == null && !this.parserHelper.isParsing()) {
                ...
                int result = readSource(positionUs, this.formatHolder, sampleHolder, false);
                if (result == -4) {
    ...
    protected boolean isEnded() {
        return this.inputStreamEnded && (this.subtitle == null || getNextEventTime() == MediaFormat.OFFSET_SAMPLE_RELATIVE);
    }
    ...
    private long getNextEventTime() {
        return (this.nextSubtitleEventIndex == -1 || this.nextSubtitleEventIndex >= this.subtitle.getEventTimeCount()) ? MediaFormat.OFFSET_SAMPLE_RELATIVE : this.subtitle.getEventTime(this.nextSubtitleEventIndex);
    }
