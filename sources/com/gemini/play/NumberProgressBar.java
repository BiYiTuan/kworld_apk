...
public class NumberProgressBar extends View {
    ...
    public NumberProgressBar(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        TypedArray attributes = context.getTheme().obtainStyledAttributes(attrs, C0216R.styleable.NumberProgressBar, defStyleAttr, 0);
        this.mReachedBarColor = attributes.getColor(3, this.default_reached_color);
        this.mUnreachedBarColor = attributes.getColor(9, this.default_unreached_color);
        this.mTextColor = attributes.getColor(4, this.default_text_color);
        this.mTextSize = attributes.getDimension(6, this.default_text_size);
        this.mReachedBarHeight = attributes.getDimension(2, this.default_reached_bar_height);
        this.mUnreachedBarHeight = attributes.getDimension(8, this.default_unreached_bar_height);
        this.mOffset = attributes.getDimension(5, this.default_progress_text_offset);
