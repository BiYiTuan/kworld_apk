...
class MySimpleAdapterVodTypeView extends SimpleAdapter {
    ...
    public MySimpleAdapterVodTypeView(Context context, List<? extends Map<String, ?>> data, int resource, String[] from, int[] to) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        LinearLayout.LayoutParams layoutParams = (LinearLayout.LayoutParams) vi.getLayoutParams();
        layoutParams.width = (int) (this.rate * 12.0f);
        layoutParams.height = (int) (this.rate * 12.0f);
