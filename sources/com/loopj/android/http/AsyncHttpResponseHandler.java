...
public abstract class AsyncHttpResponseHandler implements ResponseHandlerInterface {
    ...
    public void setUseSynchronousMode(boolean sync) {
        if (!sync && this.looper == null) {
            sync = true;
            AsyncHttpClient.log.mo1741w(LOG_TAG, "Current thread has not called Looper.prepare(). Forcing synchronous mode.");
        }
    ...
    public void onProgress(long bytesWritten, long totalSize) {
        ...
        logInterface.mo1739v(str, String.format(str2, objArr));
    }
    ...
    public void onRetry(int retryNo) {
        AsyncHttpClient.log.mo1728d(LOG_TAG, String.format("Request retry no. %d", new Object[]{Integer.valueOf(retryNo)}));
    }

    public void onCancel() {
        AsyncHttpClient.log.mo1728d(LOG_TAG, "Request got cancelled");
    }

    public void onUserException(Throwable error) {
        AsyncHttpClient.log.mo1731e(LOG_TAG, "User-space exception detected!", error);
            ...
            switch (message.what) {
                case 0:
                    ...
                    if (response == null || response.length < 3) {
                        AsyncHttpClient.log.mo1730e(LOG_TAG, "SUCCESS_MESSAGE didn't got enough params");
                        return;
                    } else {
                ...
                case 1:
                    ...
                    if (response == null || response.length < 4) {
                        AsyncHttpClient.log.mo1730e(LOG_TAG, "FAILURE_MESSAGE didn't got enough params");
                        return;
                    } else {
                ...
                case 4:
                    ...
                    if (response == null || response.length < 2) {
                        AsyncHttpClient.log.mo1730e(LOG_TAG, "PROGRESS_MESSAGE didn't got enough params");
                        return;
                    } else {
                ...
                case 5:
                    ...
                    if (response == null || response.length != 1) {
                        AsyncHttpClient.log.mo1730e(LOG_TAG, "RETRY_MESSAGE didn't get enough params");
                        return;
                    } else {
