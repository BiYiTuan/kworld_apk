...
public class AsyncHttpRequest implements Runnable {
            ...
            if (!isCancelled()) {
                ...
                if (!isCancelled()) {
                    try {
                        ...
                        if (isCancelled()) {
                            AsyncHttpClient.log.mo1731e("AsyncHttpRequest", "makeRequestWithRetries returned error", e);
                        } else {
    ...
    private void makeRequestWithRetries() throws IOException {
        ...
        cause = cause2;
        throw cause;
        AsyncHttpClient.log.mo1731e("AsyncHttpRequest", "Unhandled exception origin cause", e);
