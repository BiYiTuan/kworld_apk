...
public class RequestParams implements Serializable {
    ...
    class C07281 extends HashMap<String, String> {
        final /* synthetic */ String val$key;
        final /* synthetic */ String val$value;

        C07281(String str, String str2) {
            this.val$key = str;
            this.val$value = str2;
    ...
    public void setContentEncoding(String encoding) {
        if (encoding != null) {
            ...
            AsyncHttpClient.log.mo1728d(LOG_TAG, "setContentEncoding called with null attribute");
        }
    }
    ...
    private HttpEntity createFormEntity() {
        try {
            ...
            AsyncHttpClient.log.mo1731e(LOG_TAG, "createFormEntity failed", e);
            return null;
        }
    }
