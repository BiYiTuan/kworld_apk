...
public class MediaController extends FrameLayout {
    ...
    /* renamed from: io.vov.vitamio.widget.MediaController$1 */
    ...
    /* renamed from: io.vov.vitamio.widget.MediaController$2 */
    ...
    /* renamed from: io.vov.vitamio.widget.MediaController$3 */
    class C07553 implements OnSeekBarChangeListener {
        C07553() {
        }
    ...
    public MediaController(Context context, AttributeSet attrs) {
        ...
        this.mFromXml = false;
        this.mHandler = new C07531();
        this.mPauseListener = new C07542();
        this.mSeekListener = new C07553();
        this.mRoot = this;
        this.mFromXml = true;
    ...
    public void setWindowLayoutType() {
        if (VERSION.SDK_INT >= 14) {
            try {
                ...
                PopupWindow.class.getMethod("setWindowLayoutType", new Class[]{Integer.TYPE}).invoke(this.mWindow, new Object[]{Integer.valueOf(PointerIconCompat.TYPE_HELP)});
            } catch (Throwable e) {
                Log.m32e("setWindowLayoutType", e);
            }
        }
    }
    ...
    private void initControllerView(View v) {
        this.mPauseButton = (ImageButton) v.findViewById(getResources().getIdentifier("mediacontroller_play_pause", TtmlNode.ATTR_ID, this.mContext.getPackageName()));
        if (this.mPauseButton != null) {
            this.mPauseButton.requestFocus();
            this.mPauseButton.setOnClickListener(this.mPauseListener);
        }
        this.mProgress = (SeekBar) v.findViewById(getResources().getIdentifier("mediacontroller_seekbar", TtmlNode.ATTR_ID, this.mContext.getPackageName()));
        ...
        this.mEndTime = (TextView) v.findViewById(getResources().getIdentifier("mediacontroller_time_total", TtmlNode.ATTR_ID, this.mContext.getPackageName()));
        this.mCurrentTime = (TextView) v.findViewById(getResources().getIdentifier("mediacontroller_time_current", TtmlNode.ATTR_ID, this.mContext.getPackageName()));
        this.mFileName = (TextView) v.findViewById(getResources().getIdentifier("mediacontroller_file_name", TtmlNode.ATTR_ID, this.mContext.getPackageName()));
    ...
    public void hide() {
        if (this.mAnchor != null && this.mShowing) {
            try {
                ...
                Log.m31d("MediaController already removed", new Object[0]);
            }
            this.mShowing = false;
