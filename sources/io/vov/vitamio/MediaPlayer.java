...
public class MediaPlayer {
    ...
    private class EventHandler extends Handler {
        ...
        public void handleMessage(Message msg) {
            if (this.mMediaPlayer != null) {
                switch (msg.what) {
                    case -110:
                        Log.m33e(" for dedao MEDIA_ERROR_TIMED_OUT (%d, %d)", Integer.valueOf(msg.arg1), Integer.valueOf(msg.arg2));
                        return;
                    case 0:
                    case 300:
                        return;
                    ...
                    case 5:
                        ...
                        return;
                    case 100:
                        Log.m33e("Error (%d, %d)", Integer.valueOf(msg.arg1), Integer.valueOf(msg.arg2));
                        ...
                        return;
                    case 200:
                        Log.m34i("Info (%d, %d)", Integer.valueOf(msg.arg1), Integer.valueOf(msg.arg2));
                        if (MediaPlayer.this.mOnInfoListener != null) {
                            MediaPlayer.this.mOnInfoListener.onInfo(this.mMediaPlayer, msg.arg1, msg.arg2);
                            return;
                        }
                    ...
                    case 1000:
                        ...
                        if (this.mData.getInt(MediaPlayer.MEDIA_SUBTITLE_TYPE) == 0) {
                            Log.m34i("Subtitle : %s", this.mData.getString(MediaPlayer.MEDIA_SUBTITLE_STRING));
                            ...
                            Log.m34i("Subtitle : bitmap", new Object[0]);
                            if (MediaPlayer.this.mOnTimedTextListener != null) {
                    ...
                    case 2000:
                        ...
                        return;
                    default:
                        Log.m33e("Unknown message type " + msg.what, new Object[0]);
                        return;
                }
            }
        }
    ...
    static {
        ...
        try {
            ...
            Log.m33e("load library err ", new Object[0]);
        }
    }
    ...
    private static boolean load_omxnative_lib(String path, String name) {
        if (new File(Vitamio.getBrowserLibraryPath() + InternalZipConstants.ZIP_FILE_SEPARATOR + name).exists()) {
            return loadOMX_native(Vitamio.getBrowserLibraryPath() + InternalZipConstants.ZIP_FILE_SEPARATOR + name);
        }
        boolean load;
        if (path == "") {
    ...
    private static boolean loadVVO_native_lib(String path, String name) {
        if (new File(Vitamio.getBrowserLibraryPath() + InternalZipConstants.ZIP_FILE_SEPARATOR + name).exists()) {
            return loadVVO_native(Vitamio.getBrowserLibraryPath() + InternalZipConstants.ZIP_FILE_SEPARATOR + name);
        }
        boolean load;
        if (path == "") {
    ...
    private static boolean loadVAO_native_lib(String path, String name) {
        if (new File(Vitamio.getBrowserLibraryPath() + InternalZipConstants.ZIP_FILE_SEPARATOR + name).exists()) {
            return loadVAO_native(Vitamio.getBrowserLibraryPath() + InternalZipConstants.ZIP_FILE_SEPARATOR + name);
        }
        boolean load;
        if (path == "") {
    ...
    private static boolean loadFFmpeg_native_lib(String path, String name) {
        if (new File(Vitamio.getBrowserLibraryPath() + InternalZipConstants.ZIP_FILE_SEPARATOR + name).exists()) {
            return loadFFmpeg_native(Vitamio.getBrowserLibraryPath() + InternalZipConstants.ZIP_FILE_SEPARATOR + name);
        }
        boolean load;
        if (path == "") {
    ...
    private static boolean load_lib(String path, String name) {
        if (new File(Vitamio.getBrowserLibraryPath() + InternalZipConstants.ZIP_FILE_SEPARATOR + name).exists()) {
            System.load(Vitamio.getBrowserLibraryPath() + InternalZipConstants.ZIP_FILE_SEPARATOR + name);
        } else if (path == "") {
            System.load(name);
        } else {
    ...
    public MediaPlayer(Context ctx, boolean preferHWDecoder) {
        ...
        if (!preferHWDecoder) {
            try {
                ...
                Log.m33e("unloadOMX failed %s", e.toString());
            }
    ...
    private static void postEventFromNative(Object mediaplayer_ref, int what, int arg1, int arg2, Object obj) {
        ...
        if (mp != null) {
            try {
                ...
                Log.m33e("exception: " + e, new Object[0]);
            }
        }
    }
    ...
    public TrackInfo[] getTrackInfo(String encoding) {
        ...
        mediaFormat.setString("title", timedTextPath.substring(timedTextPath.lastIndexOf(InternalZipConstants.ZIP_FILE_SEPARATOR)));
    ...
    private SparseArray<MediaFormat> parseTrackInfo(byte[] tracks, String encoding) {
        ...
        try {
            ...
            Log.m33e("getTrackMap exception", new Object[0]);
    ...
    private void surfaceRender() {
        ...
        r6 = this;
        monitor-enter(r6);
        r2 = r6.mLocalSurface;	 Catch:{ all -> 0x0034 }
        if (r2 == 0) goto L_0x0015;
    L_0x0005:
        r2 = r6.mLocalSurface;	 Catch:{ all -> 0x0034 }
        r2 = r2.isValid();	 Catch:{ all -> 0x0034 }
        if (r2 == 0) goto L_0x0015;
    L_0x000d:
        r2 = r6.mBitmap;	 Catch:{ all -> 0x0034 }
        if (r2 == 0) goto L_0x0015;
    L_0x0011:
        r2 = r6.mByteBuffer;	 Catch:{ all -> 0x0034 }
    ...
    L_0x0016:
        return;
    L_0x0017:
        r2 = r6.mLocalSurface;	 Catch:{ Exception -> 0x0037 }
        r3 = 0;
        r0 = r2.lockCanvas(r3);	 Catch:{ Exception -> 0x0037 }
        r2 = r6.mBitmap;	 Catch:{ Exception -> 0x0037 }
        r3 = r6.mByteBuffer;	 Catch:{ Exception -> 0x0037 }
        r2.copyPixelsFromBuffer(r3);	 Catch:{ Exception -> 0x0037 }
        r2 = r6.mBitmap;	 Catch:{ Exception -> 0x0037 }
        r3 = 0;
        r4 = 0;
        r5 = 0;
        r0.drawBitmap(r2, r3, r4, r5);	 Catch:{ Exception -> 0x0037 }
        r2 = r6.mLocalSurface;	 Catch:{ Exception -> 0x0037 }
        r2.unlockCanvasAndPost(r0);	 Catch:{ Exception -> 0x0037 }
    L_0x0032:
        monitor-exit(r6);	 Catch:{ all -> 0x0034 }
        goto L_0x0016;
    L_0x0034:
    ...
    L_0x0037:
        r1 = move-exception;
        r2 = "surfaceRender";
        io.vov.vitamio.utils.Log.m32e(r2, r1);	 Catch:{ all -> 0x0034 }
        goto L_0x0032;
        */
