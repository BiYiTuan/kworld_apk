...
public final class PlaybackStateCompat implements Parcelable {
    ...
    public static final Creator<PlaybackStateCompat> CREATOR = new C00921();
    ...
    static class C00921 implements Creator<PlaybackStateCompat> {
        C00921() {
        }
    ...
    public static final class CustomAction implements Parcelable {
        public static final Creator<CustomAction> CREATOR = new C00931();
        ...
        static class C00931 implements Creator<CustomAction> {
            C00931() {
            }
