...
public class FileProvider extends ContentProvider {
    ...
    private static final String[] COLUMNS = new String[]{MediaColumns.DISPLAY_NAME, MediaColumns.SIZE};
    ...
    static class SimplePathStrategy implements PathStrategy {
        ...
        public Uri getUriForFile(File file) {
            try {
                ...
                return new Builder().scheme("content").authority(this.mAuthority).encodedPath(Uri.encode((String) mostSpecific.getKey()) + '/' + Uri.encode(path, InternalZipConstants.ZIP_FILE_SEPARATOR)).build();
            } catch (IOException e) {
    ...
    public Cursor query(Uri uri, String[] projection, String selection, String[] selectionArgs, String sortOrder) {
        ...
        while (i < length) {
            ...
            if (MediaColumns.DISPLAY_NAME.equals(col)) {
                cols[i2] = MediaColumns.DISPLAY_NAME;
                i3 = i2 + 1;
                values[i2] = file.getName();
            } else if (MediaColumns.SIZE.equals(col)) {
                cols[i2] = MediaColumns.SIZE;
                i3 = i2 + 1;
