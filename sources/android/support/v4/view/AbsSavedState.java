...
public abstract class AbsSavedState implements Parcelable {
    public static final Creator<AbsSavedState> CREATOR = ParcelableCompat.newCreator(new C08552());
    public static final AbsSavedState EMPTY_STATE = new C08541();
    private final Parcelable mSuperState;

    /* renamed from: android.support.v4.view.AbsSavedState$1 */
    static class C08541 extends AbsSavedState {
        C08541() {
            super();
        }
    }
    ...
    static class C08552 implements ParcelableCompatCreatorCallbacks<AbsSavedState> {
        C08552() {
        }
