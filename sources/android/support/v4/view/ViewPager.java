...
public class ViewPager extends ViewGroup {
    ...
    private static final Comparator<ItemInfo> COMPARATOR = new C01101();
    ...
    private static final Interpolator sInterpolator = new C01112();
    ...
    private final Runnable mEndScrollRunnable = new C01123();
    ...
    static class C01101 implements Comparator<ItemInfo> {
        C01101() {
        }
    ...
    static class C01112 implements Interpolator {
        C01112() {
        }
    ...
    class C01123 implements Runnable {
        C01123() {
        }
    ...
    class C08604 implements OnApplyWindowInsetsListener {
        private final Rect mTempRect = new Rect();
    ...
    public static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C08611());
        Parcelable adapterState;
        ClassLoader loader;
        int position;

        /* renamed from: android.support.v4.view.ViewPager$SavedState$1 */
        static class C08611 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C08611() {
            }
    ...
    void initViewPager() {
        ...
        ViewCompat.setOnApplyWindowInsetsListener(this, new C08604());
    }
