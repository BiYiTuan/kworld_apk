...
*/
    ...
    public static String getName(Context context, Uri self) {
        return queryForString(context, self, MediaColumns.DISPLAY_NAME, null);
    }

    private static String getRawType(Context context, Uri self) {
        return queryForString(context, self, MediaColumns.MIME_TYPE, null);
    }
    ...
    public static long length(Context context, Uri self) {
        return queryForLong(context, self, MediaColumns.SIZE, 0);
    }
