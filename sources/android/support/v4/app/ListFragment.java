...
public class ListFragment extends Fragment {
    ...
    View mListContainer;
    boolean mListShown;
    private final OnItemClickListener mOnClickListener = new C00422();
    View mProgressContainer;
    private final Runnable mRequestFocus = new C00411();
    ...
    class C00422 implements OnItemClickListener {
        C00422() {
        }
