...
class NotificationCompatKitKat {
    ...
    public static class Builder implements NotificationBuilderWithBuilderAccessor, NotificationBuilderWithActions {
        /* renamed from: b */
        private android.app.Notification.Builder f116b;
        ...
        public void addAction(Action action) {
            this.mActionExtrasList.add(NotificationCompatJellybean.writeActionAndGetExtras(this.f116b, action));
        }
        ...
        public Notification build() {
            ...
            this.f116b.setExtras(this.mExtras);
            Notification notification = this.f116b.build();
