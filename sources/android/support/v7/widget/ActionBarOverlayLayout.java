...
public class ActionBarOverlayLayout extends ViewGroup implements DecorContentParent, NestedScrollingParent {
    static final int[] ATTRS = new int[]{C0153R.attr.actionBarSize, 16842841};
    ...
    class C01613 implements Runnable {
        C01613() {
        }
    ...
    class C09771 extends ViewPropertyAnimatorListenerAdapter {
        C09771() {
        }
    ...
    public ActionBarOverlayLayout(Context context, AttributeSet attrs) {
        ...
        this.mTopAnimatorListener = new C09771();
        this.mRemoveActionBarHideOffset = new C01602();
        this.mAddActionBarHideOffset = new C01613();
        init(context);
    ...
    void pullChildren() {
        if (this.mContent == null) {
            this.mContent = (ContentFrameLayout) findViewById(C0153R.id.action_bar_activity_content);
            this.mActionBarTop = (ActionBarContainer) findViewById(C0153R.id.action_bar_container);
            this.mDecorToolbar = getDecorToolbar(findViewById(C0153R.id.action_bar));
        }
    }
