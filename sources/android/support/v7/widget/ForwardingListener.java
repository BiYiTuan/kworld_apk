...
public abstract class ForwardingListener implements OnTouchListener {
    ...
    class C01701 implements OnAttachStateChangeListener {
        C01701() {
        }
    ...
    private void addDetachListenerApi12(View src) {
        src.addOnAttachStateChangeListener(new C01701());
    }

    private void addDetachListenerBase(View src) {
        src.getViewTreeObserver().addOnGlobalLayoutListener(new C01712());
    }
