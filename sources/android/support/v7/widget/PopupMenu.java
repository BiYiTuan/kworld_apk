...
public class PopupMenu {
    ...
    class C01742 implements android.widget.PopupWindow.OnDismissListener {
        C01742() {
        }
    ...
    class C08851 implements Callback {
        C08851() {
        }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity) {
        this(context, anchor, gravity, C0153R.attr.popupMenuStyle, 0);
    }
    ...
    public PopupMenu(@NonNull Context context, @NonNull View anchor, int gravity, @AttrRes int popupStyleAttr, @StyleRes int popupStyleRes) {
        ...
        this.mMenu.setCallback(new C08851());
        ...
        this.mPopup.setOnDismissListener(new C01742());
    }
