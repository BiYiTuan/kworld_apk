...
public class SearchView extends LinearLayoutCompat implements CollapsibleActionView {
    ...
    class C01794 implements OnFocusChangeListener {
        C01794() {
        }
    ...
    class C01805 implements OnLayoutChangeListener {
        C01805() {
        }
    ...
    class C01816 implements OnGlobalLayoutListener {
        C01816() {
        }
    ...
    class C01827 implements OnClickListener {
        C01827() {
        }
    ...
    class C01838 implements OnKeyListener {
        C01838() {
        }
    ...
    class C01849 implements OnEditorActionListener {
        C01849() {
        }
    ...
    static class SavedState extends AbsSavedState {
        public static final Creator<SavedState> CREATOR = ParcelableCompat.newCreator(new C08871());
        boolean isIconified;

        /* renamed from: android.support.v7.widget.SearchView$SavedState$1 */
        static class C08871 implements ParcelableCompatCreatorCallbacks<SavedState> {
            C08871() {
            }
    ...
    public static class SearchAutoComplete extends AppCompatAutoCompleteTextView {
        ...
        public SearchAutoComplete(Context context, AttributeSet attrs) {
            this(context, attrs, C0153R.attr.autoCompleteTextViewStyle);
        }
    ...
    public SearchView(Context context, AttributeSet attrs) {
        this(context, attrs, C0153R.attr.searchViewStyle);
    }
    ...
    public SearchView(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        this.mShowImeRunnable = new C01761();
        this.mUpdateDrawableStateRunnable = new C01772();
        this.mReleaseCursorRunnable = new C01783();
        this.mOutsideDrawablesCache = new WeakHashMap();
        this.mOnClickListener = new C01827();
        this.mTextKeyListener = new C01838();
        this.mOnEditorActionListener = new C01849();
        ...
        TintTypedArray a = TintTypedArray.obtainStyledAttributes(context, attrs, C0153R.styleable.SearchView, defStyleAttr, 0);
        LayoutInflater.from(context).inflate(a.getResourceId(C0153R.styleable.SearchView_layout, C0153R.layout.abc_search_view), this, true);
        this.mSearchSrcTextView = (SearchAutoComplete) findViewById(C0153R.id.search_src_text);
        this.mSearchSrcTextView.setSearchView(this);
        this.mSearchEditFrame = findViewById(C0153R.id.search_edit_frame);
        this.mSearchPlate = findViewById(C0153R.id.search_plate);
        this.mSubmitArea = findViewById(C0153R.id.submit_area);
        this.mSearchButton = (ImageView) findViewById(C0153R.id.search_button);
        this.mGoButton = (ImageView) findViewById(C0153R.id.search_go_btn);
        this.mCloseButton = (ImageView) findViewById(C0153R.id.search_close_btn);
        this.mVoiceButton = (ImageView) findViewById(C0153R.id.search_voice_btn);
        this.mCollapsedIcon = (ImageView) findViewById(C0153R.id.search_mag_icon);
        ViewCompat.setBackground(this.mSearchPlate, a.getDrawable(C0153R.styleable.SearchView_queryBackground));
        ViewCompat.setBackground(this.mSubmitArea, a.getDrawable(C0153R.styleable.SearchView_submitBackground));
        this.mSearchButton.setImageDrawable(a.getDrawable(C0153R.styleable.SearchView_searchIcon));
        this.mGoButton.setImageDrawable(a.getDrawable(C0153R.styleable.SearchView_goIcon));
        this.mCloseButton.setImageDrawable(a.getDrawable(C0153R.styleable.SearchView_closeIcon));
        this.mVoiceButton.setImageDrawable(a.getDrawable(C0153R.styleable.SearchView_voiceIcon));
        this.mCollapsedIcon.setImageDrawable(a.getDrawable(C0153R.styleable.SearchView_searchIcon));
        this.mSearchHintIcon = a.getDrawable(C0153R.styleable.SearchView_searchHintIcon);
        this.mSuggestionRowLayout = a.getResourceId(C0153R.styleable.SearchView_suggestionRowLayout, C0153R.layout.abc_search_dropdown_item_icons_2line);
        this.mSuggestionCommitIconResId = a.getResourceId(C0153R.styleable.SearchView_commitIcon, 0);
        ...
        this.mSearchSrcTextView.setOnFocusChangeListener(new C01794());
        setIconifiedByDefault(a.getBoolean(C0153R.styleable.SearchView_iconifiedByDefault, true));
        int maxWidth = a.getDimensionPixelSize(C0153R.styleable.SearchView_android_maxWidth, -1);
        if (maxWidth != -1) {
            setMaxWidth(maxWidth);
        }
        this.mDefaultQueryHint = a.getText(C0153R.styleable.SearchView_defaultQueryHint);
        this.mQueryHint = a.getText(C0153R.styleable.SearchView_queryHint);
        int imeOptions = a.getInt(C0153R.styleable.SearchView_android_imeOptions, -1);
        if (imeOptions != -1) {
            setImeOptions(imeOptions);
        }
        int inputType = a.getInt(C0153R.styleable.SearchView_android_inputType, -1);
        if (inputType != -1) {
            setInputType(inputType);
        }
        setFocusable(a.getBoolean(C0153R.styleable.SearchView_android_focusable, true));
        a.recycle();
    ...
    private void addOnLayoutChangeListenerToDropDownAnchorSDK11() {
        this.mDropDownAnchor.addOnLayoutChangeListener(new C01805());
    }

    private void addOnLayoutChangeListenerToDropDownAnchorBase() {
        this.mDropDownAnchor.getViewTreeObserver().addOnGlobalLayoutListener(new C01816());
    }
    ...
    private int getPreferredWidth() {
        return getContext().getResources().getDimensionPixelSize(C0153R.dimen.abc_search_view_preferred_width);
    }

    private int getPreferredHeight() {
        return getContext().getResources().getDimensionPixelSize(C0153R.dimen.abc_search_view_preferred_height);
    }
    ...
    void adjustDropDownSizeAndPosition() {
        if (this.mDropDownAnchor.getWidth() > 1) {
            ...
            int iconOffset = this.mIconifiedByDefault ? res.getDimensionPixelSize(C0153R.dimen.abc_dropdownitem_icon_width) + res.getDimensionPixelSize(C0153R.dimen.abc_dropdownitem_text_padding_left) : 0;
