...
class ToolbarActionBar extends ActionBar {
    ...
    private final OnMenuItemClickListener mMenuClicker = new C08772();
    private final Runnable mMenuInvalidator = new C01521();
    ...
    class C08772 implements OnMenuItemClickListener {
        C08772() {
        }
...
*/
    ...
    private void ensureListMenuPresenter(Menu menu) {
        if (this.mListMenuPresenter == null && (menu instanceof MenuBuilder)) {
            ...
            this.mListMenuPresenter = new ListMenuPresenter(context2, C0153R.layout.abc_list_menu_item_layout);
