...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C09741();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C09752();
    private boolean mShowingForMode;
    ScrollingTabContainerView mTabScrollView;
    private ArrayList<TabImpl> mTabs = new ArrayList();
    private Context mThemedContext;
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C08783();

    /* renamed from: android.support.v7.app.WindowDecorActionBar$3 */
    class C08783 implements ViewPropertyAnimatorUpdateListener {
        C08783() {
        }
    ...
    class C09741 extends ViewPropertyAnimatorListenerAdapter {
        C09741() {
        }
    ...
    class C09752 extends ViewPropertyAnimatorListenerAdapter {
        C09752() {
        }
    ...
    private void init(View decor) {
        this.mOverlayLayout = (ActionBarOverlayLayout) decor.findViewById(C0153R.id.decor_content_parent);
        if (this.mOverlayLayout != null) {
            this.mOverlayLayout.setActionBarVisibilityCallback(this);
        }
        this.mDecorToolbar = getDecorToolbar(decor.findViewById(C0153R.id.action_bar));
        this.mContextView = (ActionBarContextView) decor.findViewById(C0153R.id.action_context_bar);
        this.mContainerView = (ActionBarContainer) decor.findViewById(C0153R.id.action_bar_container);
        ...
        TypedArray a = this.mContext.obtainStyledAttributes(null, C0153R.styleable.ActionBar, C0153R.attr.actionBarStyle, 0);
        if (a.getBoolean(C0153R.styleable.ActionBar_hideOnContentScroll, false)) {
            setHideOnContentScrollEnabled(true);
        }
        int elevation = a.getDimensionPixelSize(C0153R.styleable.ActionBar_elevation, 0);
        if (elevation != 0) {
    ...
    public Context getThemedContext() {
        if (this.mThemedContext == null) {
            ...
            this.mContext.getTheme().resolveAttribute(C0153R.attr.actionBarWidgetTheme, outValue, true);
