...
public class ConstraintSet {
    ...
    static {
        ...
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintHorizontal_chainStyle, 41);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintVertical_chainStyle, 42);
        ...
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintLeft_creator, 60);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintTop_creator, 60);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintRight_creator, 60);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintBottom_creator, 60);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintBaseline_creator, 60);
        ...
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_alpha, 43);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_elevation, 44);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_rotationX, 45);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_rotationY, 46);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_scaleX, 47);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_scaleY, 48);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_transformPivotX, 49);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_transformPivotY, 50);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_translationX, 51);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_translationY, 52);
        mapToConstant.append(C0002R.styleable.ConstraintSet_android_translationZ, 53);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintWidth_default, 54);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintHeight_default, 55);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintWidth_max, 56);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintHeight_max, 57);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintWidth_min, 58);
        mapToConstant.append(C0002R.styleable.ConstraintSet_layout_constraintHeight_min, 59);
