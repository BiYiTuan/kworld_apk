...
*/
        ...
        monitor-enter(r12);
        r2 = cz.msebera.android.httpclient.impl.conn.CPoolProxy.detach(r12);	 Catch:{ all -> 0x00c3 }
    ...
    L_0x000e:
        ...
        r0 = (cz.msebera.android.httpclient.conn.ManagedHttpClientConnection) r0;	 Catch:{ all -> 0x00c3 }
    ...
    L_0x0096:
        ...
        r4 = (cz.msebera.android.httpclient.conn.routing.HttpRoute) r4;	 Catch:{ all -> 0x00c3 }
