...
class IOUtils {
    ...
    static void copyFile(File in, File out) throws IOException {
        FileChannel c1;
        FileChannel c2;
        RandomAccessFile f1 = new RandomAccessFile(in, InternalZipConstants.READ_MODE);
        RandomAccessFile f2 = new RandomAccessFile(out, InternalZipConstants.WRITE_MODE);
        try {
            c1 = f1.getChannel();
            c2 = f2.getChannel();
