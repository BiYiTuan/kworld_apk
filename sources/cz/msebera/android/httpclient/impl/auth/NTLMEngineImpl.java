...
final class NTLMEngineImpl implements NTLMEngine {
    ...
    static class MD4 {
        /* renamed from: A */
        protected int f22A = 1732584193;
        /* renamed from: B */
        protected int f23B = -271733879;
        /* renamed from: C */
        protected int f24C = -1732584194;
        /* renamed from: D */
        protected int f25D = 271733878;
        ...
        byte[] getOutput() {
            ...
            NTLMEngineImpl.writeULong(result, this.f22A, 0);
            NTLMEngineImpl.writeULong(result, this.f23B, 4);
            NTLMEngineImpl.writeULong(result, this.f24C, 8);
            NTLMEngineImpl.writeULong(result, this.f25D, 12);
            return result;
        }
        ...
        protected void round1(int[] d) {
            this.f22A = NTLMEngineImpl.rotintlft((this.f22A + NTLMEngineImpl.m416F(this.f23B, this.f24C, this.f25D)) + d[0], 3);
            this.f25D = NTLMEngineImpl.rotintlft((this.f25D + NTLMEngineImpl.m416F(this.f22A, this.f23B, this.f24C)) + d[1], 7);
            this.f24C = NTLMEngineImpl.rotintlft((this.f24C + NTLMEngineImpl.m416F(this.f25D, this.f22A, this.f23B)) + d[2], 11);
            this.f23B = NTLMEngineImpl.rotintlft((this.f23B + NTLMEngineImpl.m416F(this.f24C, this.f25D, this.f22A)) + d[3], 19);
            this.f22A = NTLMEngineImpl.rotintlft((this.f22A + NTLMEngineImpl.m416F(this.f23B, this.f24C, this.f25D)) + d[4], 3);
            this.f25D = NTLMEngineImpl.rotintlft((this.f25D + NTLMEngineImpl.m416F(this.f22A, this.f23B, this.f24C)) + d[5], 7);
            this.f24C = NTLMEngineImpl.rotintlft((this.f24C + NTLMEngineImpl.m416F(this.f25D, this.f22A, this.f23B)) + d[6], 11);
            this.f23B = NTLMEngineImpl.rotintlft((this.f23B + NTLMEngineImpl.m416F(this.f24C, this.f25D, this.f22A)) + d[7], 19);
            this.f22A = NTLMEngineImpl.rotintlft((this.f22A + NTLMEngineImpl.m416F(this.f23B, this.f24C, this.f25D)) + d[8], 3);
            this.f25D = NTLMEngineImpl.rotintlft((this.f25D + NTLMEngineImpl.m416F(this.f22A, this.f23B, this.f24C)) + d[9], 7);
            this.f24C = NTLMEngineImpl.rotintlft((this.f24C + NTLMEngineImpl.m416F(this.f25D, this.f22A, this.f23B)) + d[10], 11);
            this.f23B = NTLMEngineImpl.rotintlft((this.f23B + NTLMEngineImpl.m416F(this.f24C, this.f25D, this.f22A)) + d[11], 19);
            this.f22A = NTLMEngineImpl.rotintlft((this.f22A + NTLMEngineImpl.m416F(this.f23B, this.f24C, this.f25D)) + d[12], 3);
            this.f25D = NTLMEngineImpl.rotintlft((this.f25D + NTLMEngineImpl.m416F(this.f22A, this.f23B, this.f24C)) + d[13], 7);
            this.f24C = NTLMEngineImpl.rotintlft((this.f24C + NTLMEngineImpl.m416F(this.f25D, this.f22A, this.f23B)) + d[14], 11);
            this.f23B = NTLMEngineImpl.rotintlft((this.f23B + NTLMEngineImpl.m416F(this.f24C, this.f25D, this.f22A)) + d[15], 19);
        }

        protected void round2(int[] d) {
            this.f22A = NTLMEngineImpl.rotintlft(((this.f22A + NTLMEngineImpl.m417G(this.f23B, this.f24C, this.f25D)) + d[0]) + 1518500249, 3);
            this.f25D = NTLMEngineImpl.rotintlft(((this.f25D + NTLMEngineImpl.m417G(this.f22A, this.f23B, this.f24C)) + d[4]) + 1518500249, 5);
            this.f24C = NTLMEngineImpl.rotintlft(((this.f24C + NTLMEngineImpl.m417G(this.f25D, this.f22A, this.f23B)) + d[8]) + 1518500249, 9);
            this.f23B = NTLMEngineImpl.rotintlft(((this.f23B + NTLMEngineImpl.m417G(this.f24C, this.f25D, this.f22A)) + d[12]) + 1518500249, 13);
            this.f22A = NTLMEngineImpl.rotintlft(((this.f22A + NTLMEngineImpl.m417G(this.f23B, this.f24C, this.f25D)) + d[1]) + 1518500249, 3);
            this.f25D = NTLMEngineImpl.rotintlft(((this.f25D + NTLMEngineImpl.m417G(this.f22A, this.f23B, this.f24C)) + d[5]) + 1518500249, 5);
            this.f24C = NTLMEngineImpl.rotintlft(((this.f24C + NTLMEngineImpl.m417G(this.f25D, this.f22A, this.f23B)) + d[9]) + 1518500249, 9);
            this.f23B = NTLMEngineImpl.rotintlft(((this.f23B + NTLMEngineImpl.m417G(this.f24C, this.f25D, this.f22A)) + d[13]) + 1518500249, 13);
            this.f22A = NTLMEngineImpl.rotintlft(((this.f22A + NTLMEngineImpl.m417G(this.f23B, this.f24C, this.f25D)) + d[2]) + 1518500249, 3);
            this.f25D = NTLMEngineImpl.rotintlft(((this.f25D + NTLMEngineImpl.m417G(this.f22A, this.f23B, this.f24C)) + d[6]) + 1518500249, 5);
            this.f24C = NTLMEngineImpl.rotintlft(((this.f24C + NTLMEngineImpl.m417G(this.f25D, this.f22A, this.f23B)) + d[10]) + 1518500249, 9);
            this.f23B = NTLMEngineImpl.rotintlft(((this.f23B + NTLMEngineImpl.m417G(this.f24C, this.f25D, this.f22A)) + d[14]) + 1518500249, 13);
            this.f22A = NTLMEngineImpl.rotintlft(((this.f22A + NTLMEngineImpl.m417G(this.f23B, this.f24C, this.f25D)) + d[3]) + 1518500249, 3);
            this.f25D = NTLMEngineImpl.rotintlft(((this.f25D + NTLMEngineImpl.m417G(this.f22A, this.f23B, this.f24C)) + d[7]) + 1518500249, 5);
            this.f24C = NTLMEngineImpl.rotintlft(((this.f24C + NTLMEngineImpl.m417G(this.f25D, this.f22A, this.f23B)) + d[11]) + 1518500249, 9);
            this.f23B = NTLMEngineImpl.rotintlft(((this.f23B + NTLMEngineImpl.m417G(this.f24C, this.f25D, this.f22A)) + d[15]) + 1518500249, 13);
        }

        protected void round3(int[] d) {
            this.f22A = NTLMEngineImpl.rotintlft(((this.f22A + NTLMEngineImpl.m418H(this.f23B, this.f24C, this.f25D)) + d[0]) + 1859775393, 3);
            this.f25D = NTLMEngineImpl.rotintlft(((this.f25D + NTLMEngineImpl.m418H(this.f22A, this.f23B, this.f24C)) + d[8]) + 1859775393, 9);
            this.f24C = NTLMEngineImpl.rotintlft(((this.f24C + NTLMEngineImpl.m418H(this.f25D, this.f22A, this.f23B)) + d[4]) + 1859775393, 11);
            this.f23B = NTLMEngineImpl.rotintlft(((this.f23B + NTLMEngineImpl.m418H(this.f24C, this.f25D, this.f22A)) + d[12]) + 1859775393, 15);
            this.f22A = NTLMEngineImpl.rotintlft(((this.f22A + NTLMEngineImpl.m418H(this.f23B, this.f24C, this.f25D)) + d[2]) + 1859775393, 3);
            this.f25D = NTLMEngineImpl.rotintlft(((this.f25D + NTLMEngineImpl.m418H(this.f22A, this.f23B, this.f24C)) + d[10]) + 1859775393, 9);
            this.f24C = NTLMEngineImpl.rotintlft(((this.f24C + NTLMEngineImpl.m418H(this.f25D, this.f22A, this.f23B)) + d[6]) + 1859775393, 11);
            this.f23B = NTLMEngineImpl.rotintlft(((this.f23B + NTLMEngineImpl.m418H(this.f24C, this.f25D, this.f22A)) + d[14]) + 1859775393, 15);
            this.f22A = NTLMEngineImpl.rotintlft(((this.f22A + NTLMEngineImpl.m418H(this.f23B, this.f24C, this.f25D)) + d[1]) + 1859775393, 3);
            this.f25D = NTLMEngineImpl.rotintlft(((this.f25D + NTLMEngineImpl.m418H(this.f22A, this.f23B, this.f24C)) + d[9]) + 1859775393, 9);
            this.f24C = NTLMEngineImpl.rotintlft(((this.f24C + NTLMEngineImpl.m418H(this.f25D, this.f22A, this.f23B)) + d[5]) + 1859775393, 11);
            this.f23B = NTLMEngineImpl.rotintlft(((this.f23B + NTLMEngineImpl.m418H(this.f24C, this.f25D, this.f22A)) + d[13]) + 1859775393, 15);
            this.f22A = NTLMEngineImpl.rotintlft(((this.f22A + NTLMEngineImpl.m418H(this.f23B, this.f24C, this.f25D)) + d[3]) + 1859775393, 3);
            this.f25D = NTLMEngineImpl.rotintlft(((this.f25D + NTLMEngineImpl.m418H(this.f22A, this.f23B, this.f24C)) + d[11]) + 1859775393, 9);
            this.f24C = NTLMEngineImpl.rotintlft(((this.f24C + NTLMEngineImpl.m418H(this.f25D, this.f22A, this.f23B)) + d[7]) + 1859775393, 11);
            this.f23B = NTLMEngineImpl.rotintlft(((this.f23B + NTLMEngineImpl.m418H(this.f24C, this.f25D, this.f22A)) + d[15]) + 1859775393, 15);
        }
    }
    ...
    /* renamed from: F */
    static int m416F(int x, int y, int z) {
        return (x & y) | ((x ^ -1) & z);
    }

    /* renamed from: G */
    static int m417G(int x, int y, int z) {
        return ((x & y) | (x & z)) | (y & z);
    }

    /* renamed from: H */
    static int m418H(int x, int y, int z) {
        return (x ^ y) ^ z;
    }
