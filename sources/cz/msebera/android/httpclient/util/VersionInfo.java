...
public class VersionInfo {
    ...
    public static VersionInfo loadVersionInfo(String pckg, ClassLoader clsldr) {
        ...
        InputStream is;
        try {
            is = cl.getResourceAsStream(pckg.replace('.', '/') + InternalZipConstants.ZIP_FILE_SEPARATOR + VERSION_PROPERTY_FILE);
            if (is != null) {
    ...
    public static String getUserAgent(String name, String pkg, Class<?> cls) {
        ...
        return name + InternalZipConstants.ZIP_FILE_SEPARATOR + (vi != null ? vi.getRelease() : UNAVAILABLE) + " (Java 1.5 minimum; Java/" + System.getProperty("java.version") + ")";
    }
}
